...
const GoogleSignInButton = ({
  ...
  <button
    className={`gsi-material-button flex items-center justify-center p-2 border border-gray-300 rounded-md shadow-sm transition-shadow duration-200 w-full max-w-xs mx-auto ${
